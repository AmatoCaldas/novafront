    ...
    <body>
        ...
        <div class="container px-5 pt-3" id="container"> 
            <div class="pt-3 text-justify" id="introducao">    
                ...
                <p class="fw-light">- Você poderá escolher o endereço da sua casa ou outro que for mais conveniente para você (ex. trabalho, casa de um amigo/a, parente, etc.) em Campo Grande.</p>
                <p class="fw-light">- Você deve ser morador de Campo Grande e estar cadastrado/a em alguma das Unidades Dispensadoras de Medicamentos (UDM) do município (CEDIP, HUMAP, CTA).</p>
            ...
            <form class="row" id="cadastro">
                <input type="hidden" id="id_cidade" name="id_cidade" value="1"/> 
                ...
                <div class="pt-3" id="parte2" style="display: none;">
                    ...
                    <div class="mb-3">
                        <label for="st_morador" class="form-label">Você é morador de Campo Grande?</label>
                ...
                <div class="pt-3 text-justify" id="parte5" style="display: none;">
                    ...
                    <p class="fw-light">Infelizmente, no momento, a entrega pelos Correios/Transportadora somente está disponível para as pessoas que já possuem cadastro no CTA, CEDIP ou HUMAP do município de Campo Grande/MS.
                    ...
                    <p></p>
                    <p class="fw-light">- CTA
                    <br/>Endereço: Rua Anhanduí, 353, Vila Carvalho, Campo Grande - MS, 79.005-051
                    <br/>Telefone: (67) 2020-1701

                    <p class="fw-light">- CEDIP / Centro de Doenças Infecto Parasitárias
                    <br/>Endereço:  / R. dos Coqueiros, S/N - Nova Bahia, Campo Grande - MS, 79034-000
                    
                    <p class="fw-light">- HUMAP / Hosp. Universitário Maria Aparecida Pedrossian / 
                    <br/>Endereço: Av. Sen. Filinto Müler, 355 - Vila Ipiranga, Campo Grande - MS, 79080-190
                ...
                <div class="pt-3 text-justify" id="parte6" style="display: none;">
                    ...
                    <p class="h1 pt-3">Não sou morador de Campo Grande</p>
                    <p class="fw-light">No momento, a entrega pelos Correios/Transportadora somente está disponível para as pessoas moradoras/residentes em Campo Grande e que possuem cadastro em alguma Unidade Dispensadora de Medicamentos (UDM) do município.</p>
                ...
                <div class="pt-3" id="parte7" style="display: none;">
                    ...
                    <p class="h1">Sou morador de Campo Grande: dados cadastrais</p>
                ...
                <div class="pt-3" id="parte8" style="display: none;">
                    ...
                    <div class="form-check">
                        ...
                        <label class="form-check-label" for="id_udm1">
                            CTA / Centro de Testagem e Aconselhamento / Rua Anhanduí, 393, Vila Carvalho, Campo Grande-MS, 79005-051
                        </label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="id_udm" id="id_udm2" value="370">
                        <label class="form-check-label" for="id_udm2">
                            CEDIP / Centro de Doenças Infecto Parasitárias / R. dos Coqueiros, S/N - Nova Bahia, Campo Grande - MS, 79034-000
                        </label>
                    </div>
                    ...
                    <div class="form-check">
                        ...
                        <label class="form-check-label" for="id_udm3">
                            HUMAP / Hosp. Universitário Maria Aparecida Pedrossian / Av. Sen. Filinto Müler, 355 - Vila Ipiranga, Campo Grande - MS, 79080-190
                        </label>
                    </div>
                ...
                <div class="pt-3 text-justify" id="parte10" style="display: none;">
                    ...
                    <p class="fw-light">A entrega por Correios/Transportadora está limitada a endereços  pertencentes a Campo Grande.</p>
                ...
                <div class="pt-3 text-justify" id="parte18" style="display: none;">
                    ...
                    <p class="fw-light">Se tiver alguma questão específica que necessita de auxílio, entre em contato diretamente pelo WhatsApp da Entrega Virtual (67 98164-0004) mencionando qual sua necessidade.</p>
                </div>
            </form>
        </div>
    </body>
