...
<body>
    ...
    <div class="container px-5 pt-3" id="container">
        <div class="pt-3 text-justify" id="introducao">
            <p class="fw-light">Essa é uma iniciativa da Secretaria Municipal de Saúde de Porto Alegre, em parceria com
                o Projeto A Hora é Agora da Escola Nacional de Saúde Pública Sérgio Arouca (Ensp)/Fiocruz e os Centros
                de Controle e Prevenção de Doenças dos Estados Unidos da América (CDC), com recursos do Plano de
                Emergência do Presidente dos EUA para Alívio da Aids (PEPFAR) - https://www.ahoraeagora.org/</p>
            ...
            <p class="fw-light">- Você poderá escolher o endereço da sua casa ou outro que for mais conveniente para
                você (ex. trabalho, casa de um amigo/a, parente, etc.) em Porto Alegre.</p>
            <p class="fw-light">- Você deve ser morador de Porto Alegre e estar cadastrado/a em alguma das Unidades
                Dispensadoras de Medicamentos (UDM) do município:</p>

            <p class="fw-light">- UDM IAPI
                <br />Endereço: Rua Três de Abril, 90 / 2º andar - Passo d'Areia, Porto Alegre - RS, CEP: 90520-200
                <br />Telefone: (51) 3289-3414
                <br />WhatsApp: (51) 98223-0099
                <br />Horário de funcionamento: 8h às 12h e 13h às 17h de segunda a sexta-feira
            </p>

            <p class="fw-light">- CTA Navegantes
                <br />Endereço: Av. Presidente Franklin Roosevelt, 5 (2⁰ andar) - Navegantes.
                <br />Telefone: (51) 98329-3177
                <br />Horário de funcionamento: 8h às 18h de segunda a sexta-feira
            </p>
        ...
        <form class="row" id="cadastro">
            <input type="hidden" id="id_cidade" name="id_cidade" value="4" />
            ...
            <div id="parte1">
                ...
                <div class="d-grid gap-2 py-3">
                    <button type="button" class="btn btn-primary btn-lg" style="border-radius: 30px;"
                        id="btn-parte1">Continuar</button>
                </div>
            </div>
            ...
            <div class="pt-3" id="parte2" style="display: none;">
                ...
                <div class="mb-3">
                    <label for="st_morador" class="form-label">Você é morador de Porto Alegre?</label>
            ...
            <div class="pt-3" id="parte3" style="display: none;">
                ...
                <div class="d-grid gap-2 py-3">
                    <button type="button" class="btn btn-primary btn-lg" style="border-radius: 30px;"
                        id="btn-parte3">Continuar</button>
                </div>
            </div>
            ...
            <div class="pt-3" id="parte4" style="display: none;">
                ...
                <div class="d-grid gap-2 py-3">
                    <button type="button" class="btn btn-primary btn-lg" style="border-radius: 30px;"
                        id="btn-parte4">Continuar</button>
                </div>
            </div>
            ...
            <div class="pt-3 text-justify" id="parte5" style="display: none;">
                ...
                <p class="fw-light">Infelizmente, no momento, a entrega pelos Correios/Transportadora somente está
                    ...
                    (UDM) do município de Porto Alegre/RS.
                ...
                <p class="fw-light">* Na próxima vez, você poderá solicitar a entrega pelos Correios/Transportadora por
                ...
                <div class="d-grid gap-2 py-3">
                    <button type="button" class="btn btn-primary btn-lg" style="border-radius: 30px;"
                        id="btn-parte5">Continuar</button>
                </div>
            </div>
            ...
            <div class="pt-3 text-justify" id="parte6" style="display: none;">
                ...
                <p class="h1 pt-3">Não sou morador de Porto Alegre</p>
                <p class="fw-light">No momento, a entrega pelos Correios/Transportadora somente está disponível para as
                    pessoas moradoras/residentes em Porto Alegre e que possuem cadastro em alguma Unidade Dispensadora
                ...
                <div class="d-grid gap-2 py-3">
                    <button type="button" class="btn btn-primary btn-lg" style="border-radius: 30px;"
                        id="btn-parte6">Enviar formulário</button>
                </div>
            </div>
            ...
            <div class="pt-3" id="parte7" style="display: none;">
                ...
                <p class="h1">Sou morador de Porto Alegre: dados cadastrais</p>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="ds_nome_civil" name="ds_nome_civil"
                        placeholder="Digite o nome civil">
                </div>

                <div class="mb-3">
                    <label for="ds_nome_social" class="form-label">Nome social (se tiver)</label>
                    <input type="text" class="form-control" id="ds_nome_social" name="ds_nome_social"
                        placeholder="Digite o nome social (se tiver)">
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="ds_nome_mae" name="ds_nome_mae"
                ...
                <div class="d-grid gap-2 py-3">
                    <button type="button" class="btn btn-primary btn-lg" style="border-radius: 30px;"
                        id="btn-parte7">Continuar</button>
                </div>
            </div>
            ...
            <div class="pt-3" id="parte8" style="display: none;">
                ...
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="id_udm" id="id_udm1" value="400">
                    <label class="form-check-label" for="id_udm1">
                        IAPI - Rua Três de Abril, 90 / 2º andar - Passo d'Areia, Porto Alegre - RS
                    </label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="id_udm" id="id_udm2" value="I44">
                    <label class="form-check-label" for="id_udm2">
                        CTA Navegantes - Av. Presidente Franklin Roosevelt, 5 (2⁰ andar) - Navegantes.
                    </label>
                </div>
                ...
                <div class="d-grid gap-2 py-3">
                    <button type="button" class="btn btn-primary btn-lg" style="border-radius: 30px;"
                        id="btn-parte8">Continuar</button>
                </div>
            </div>
            <div class="pt-3 text-justify" id="parte9" style="display: none;">
                ...
                <div class="alert alert-info" role="alert">
                    Caso tenha até 10 úteis de medicamentos, sugerimos que vá até a UDM.
                </div>
                ...
                <div class="d-grid gap-2 py-3">
                    <button type="button" class="btn btn-primary btn-lg" style="border-radius: 30px;"
                        id="btn-parte9">Continuar</button>
                </div>
            </div>
            ...
            <div class="pt-3 text-justify" id="parte10" style="display: none;">
                ...
                <p class="fw-light">A entrega por Correios/Transportadora está limitada a endereços pertencentes a Porto
                    Alegre.</p>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="ds_ponto_referencia" name="ds_ponto_referencia"
                        placeholder="">
                </div>
                ...
                <div class="d-grid gap-2 py-3">
                    <button type="button" class="btn btn-primary btn-lg" style="border-radius: 30px;"
                        id="btn-parte10">Continuar</button>
                </div>
            </div>
            ...
            <div class="pt-3 text-justify" id="parte11" style="display: none;">
                ...
                <p class="fw-light">Eu autorizo a Secretaria Municipal de Saúde de Porto Alegre e a Unidade Dispensadora
                    de Medicamentos na qual sou cadastrado, a enviar pelos Correios/Transportadora os meus medicamentos
                    para até 3 (meses) meses, conforme disponibilidade de estoque e validade da prescrição médica, para
                ...
                <div class="d-grid gap-2 py-3">
                    <button type="button" class="btn btn-primary btn-lg" style="border-radius: 30px;"
                        id="btn-parte11">Continuar</button>
                </div>
            </div>
            ...
            <div class="pt-3" id="parte12" style="display: none;">
                ...
                <div class="d-grid gap-2 py-3">
                    <button type="button" class="btn btn-primary btn-lg" style="border-radius: 30px;"
                        id="btn-parte12">Continuar</button>
                </div>
            </div>
            ...
            <div class="pt-3" id="parte13" style="display: none;">
                ...
                <p class="fw-light">Se você não tem um formulário de solicitação de medicamentos válido (perda,
                    interrupção de tratamento, extravio, transferência, etc), entre em contato com o WhatsApp da Entrega
                    Virtual (51) 982230099 que iremos lhe ajudar.</p>
            </div>
            ...
            <div class="pt-3" id="parte14" style="display: none;">
                ...
                <div class="d-grid gap-2 py-3">
                    <button type="button" class="btn btn-primary btn-lg" style="border-radius: 30px;"
                        id="btn-parte14">Enviar arquivo</button>
                </div>
            </div>
            ...
            <div class="pt-3 text-justify" id="parte15" style="display: none;">
                ...
                <div class="d-grid gap-2 py-3">
                    <button type="button" class="btn btn-primary btn-lg" style="border-radius: 30px;"
                        id="btn-parte15">Enviar arquivo</button>
                </div>
            </div>
            ...
            <div class="pt-3" id="parte16" style="display: none;">
                ...
                <div class="d-grid gap-2 py-3">
                    <button type="button" class="btn btn-primary btn-lg" style="border-radius: 30px;"
                        id="btn-parte16">Enviar formulário</button>
                </div>
            ...
            <div class="pt-3" id="parte17" style="display: none;">
                ...
                <div class="alert alert-info" role="alert">
                    Devido ao prazo de entrega dos correios, vá somente após 7 dias úteis.
                </div>
            ...
            <div class="pt-3 text-justify" id="parte18" style="display: none;">
                ...
                <p class="fw-light">Se tiver alguma questão específica que necessita de auxílio, entre em contato
                    diretamente pelo WhatsApp da Entrega Virtual (51) 98223-0099 (IAPI) e
                    (51) 98329-3177 (Navegantes), mencionando qual sua necessidade.</p>
            </div>
        </form>
    </div>
</body>
